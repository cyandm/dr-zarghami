...
<<<<<<< HEAD
  ...
  var swiper;
=======
  var certificate = new Swiper(".certificate-slider", {
    autoplay: {
      delay: 5e3,
      disableOnInteraction: false
    },
...
>>>>>>> 3379a71eccaa8be7f5708b29b0265f26569c26a7

  // js/modules/front-page.js
  var animateletter = document.querySelectorAll(".animate-letter");
  if (animateletter) {
    let typitvs = function(element) {
  ...
  var swiper;
  var tabLinks = document.querySelectorAll(".landing-tablinks");
  if (tabLinks) {
  ...
  var radiosparent = document.querySelectorAll(".content");
  radios.forEach((elem) => {
  ...
  jQuery(document).ready(function($) {
    ...
    if (form) {
      let closeToaster2 = function() {
        $(".form-message").removeClass("show");
      };
      var closeToaster = closeToaster2;
          ...
          $.ajax({
            ...
            success: function(response) {
              if (response.success === true) {
                ...
                $("#success_message").html(
                  response.message + '<div class="form-message-close"><i class="icon-close"></i></div>'
                );
  ...
  // js/modules/service-comment-form.js
  jQuery(document).ready(function($) {
      ...
      form.submit(function(e) {
        ...
        $.each(allData, function(key, value) {
          ...
          function fieldName(fieldName2) {
            ...
            if (fieldName2 == "service") {
              return "\u0627\u0646\u062A\u062E\u0627\u0628 \u062E\u062F\u0645\u0627\u062A ";
            }
            if (fieldName2 == "rating") {

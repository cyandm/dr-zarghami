(() => {
  ...
  // js/modules/change-position-header-with-scroll.js
  var require_change_position_header_with_scroll = __commonJS({
    "js/modules/change-position-header-with-scroll.js"() {
      var headerDoc = document.querySelector("header");
      if (!headerDoc)
        return;
  ...
  var import_change_position_header_with_scroll = __toESM(require_change_position_header_with_scroll());
  ...
  // js/modules/studentForm.js
  function studentForm() {
    const articleForm = document.querySelector("#send-article-form");
    if (!articleForm)
      return;
    articleForm.addEventListener("submit", (e2) => {
      e2.preventDefault();
        ...
        $.ajax({
          ...
          error: (xhr, status, error) => {
            ...
            try {
              ...
              console.error("Error parsing response:", e3);
            }
